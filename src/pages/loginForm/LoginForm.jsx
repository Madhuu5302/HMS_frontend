...
function LoginForm() {
  ...
  const loginHandler = async () => {
    try {
      ...
      //console.log("Response Access: ",responseData.access);
      localStorage.setItem("access", responseData.access);
      localStorage.setItem("role", responseData.role); // Assuming the role is part of the response
 
      if (responseData.role === "admin") {
        navigate("/admin-dashboard");
      } else if (responseData.role === "hotel_owner") {
